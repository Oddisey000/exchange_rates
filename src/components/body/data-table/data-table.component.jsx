            ...
            <StyledTableRow key={row.currencyName}>
              <StyledTableCell component="th" scope="row">
                <div className="currency-name">
                  {row.currencyName} <p style={{fontWeight: "bold"}}>&nbsp;{row.nameShort}</p>
                </div>
              </StyledTableCell>
              <StyledTableCell style={{fontSize: "20px"}} align="center">{row.buyPrice}</StyledTableCell>
              <StyledTableCell style={{fontSize: "20px"}} align="center">{row.sellPrice}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
